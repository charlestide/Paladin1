                            ...
                            {{--<div class="col-sm-4">--}}
                                {{--<div class="panel stat-right no-margin no-box-shadow">--}}
                                    {{--<div class="panel-body">--}}
                                        {{--<h4 class="no-margin"> 队列任务 </h4>--}}
                                        {{--<p class="text-muted"> <small>总任务数 {{$queueTotalLength}}</small></p>--}}

                                    {{--@php--}}
                                        {{--$barColors = ['lilac','teal','warning','success','danger','primary'];--}}
                                    {{--@endphp--}}

                                    {{--@foreach($queues as $queueName => $queueLength)--}}
                                        {{--<span>{{$queueName}}</span><span class="pull-right">({{$queueLength}})</span>--}}
                                        {{--<div class="progress progress-xs">--}}
                                            {{--<div class="progress-bar progress-bar-{{$barColors[$loop->index]}}"--}}
                                                 {{--role="progressbar" aria-valuenow="{{$queueLength}}" aria-valuemin="0"--}}
                                                 {{--aria-valuemax="{{$queueTotalLength}}"--}}
                                                 {{--style="width: {{$queueTotalLength ? ceil($queueLength/($queueTotalLength))*100 : 0}}%"></div>--}}
                                        {{--</div><!-- /.progress -->--}}
                                    {{--@endforeach--}}
                                    {{--</div><!-- /.panel-body -->--}}
                ...
                <div class="row">
                        ...
                        <div class="panel rounded shadow">
                            ...
                            <div class="panel-body text-center">
                                <p class="h4 no-margin inner-all text-strong">
                                    {{--<span class="block">{{$defaultQueueLength}}</span>--}}
                                </p>
                            </div><!-- /.panel-body -->
                        </div><!-- /.panel -->
                    ...
                    <div class="col-md-12 col-sm-4 col-xs-4 col-xs-override">
                        ...
                        <div class="panel rounded shadow">
                            ...
                            <div class="panel-body text-center">
                                <p class="h4 no-margin inner-all text-strong">
                                    {{--<span class="block">{{$highQueueLength}}</span>--}}
                                </p>
                            </div><!-- /.panel-body -->
                        </div><!-- /.panel -->
